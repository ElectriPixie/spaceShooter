...
class Game {
  ...
  function Game() {
    ...
    //var scoreContainer:MovieClip = _root.createEmptyMovieClip("scoreContainer", _root.getNextHighestDepth());
    ...
    var addPowerUp:Function = function()
    {
      ...
      container['powerUp'+powerUpId].onEnterFrame = function()
      {
        if(gameOver)
        {
          ...
          //var movex:Number = random(8);
          //var movey:Number = random(8);
          this._y += 6;
    ...
    {
      //enemyContainer.attachMovie('mcEnemy', 'enemy'+enemyID, enemyContainer.getNextHighestDepth());
						...
						if(this._x <= container.mcMain._x+30 && this._x >= container.mcMain._x -30)
{
  ...
  //_root.score.text = "Score: "+score+" You got hit";
  powerUpLevel -= 1;
  if(powerUpLevel <= 0)
  {
    //explosionSound.start();
